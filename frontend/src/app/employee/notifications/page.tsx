...
export default function EmployeeNotificationsPage() {
  ...
  async function markAllAsRead() {
    ...
    try {
      await fetch(`${API}/Notifications/employee/${employeeId}/read-all`, { method: "PUT" });
    ...
    <EamsShell role="Employee">
      <div className="professional-attendance" style={{ maxWidth: "900px", margin: "0 auto", padding: "28px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "24px", flexWrap: "wrap", gap: "12px" }}>
          <div>
            ...
            <p style={{ margin: "4px 0 0", color: "#64748b", fontSize: "14px" }}>
              Stay updated with approvals, alerts, and system messages.
            </p>
          </div>
        ...
        <div style={{ display: "flex", gap: "14px", marginBottom: "24px", flexWrap: "wrap" }}>
          {[
            { label: "Total", count: notifications.length, color: "#2563eb", bg: "#eff6ff", border: "#bfdbfe" },
            { label: "Unread", count: unreadCount, color: "#d97706", bg: "#fffbeb", border: "#fde68a" },
            { label: "Read", count: notifications.length - unreadCount, color: "#059669", bg: "#f0fdf4", border: "#bbf7d0" },
          ].map((stat) => (
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <p style={{ margin: 0, color: "#64748b", fontSize: "14px" }}>
              {filter === "unread" ? "You're all caught up! Everything has been read." : "Notifications from your manager will appear here."}
            </p>
          </div>
        ) : (
